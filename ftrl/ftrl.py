...
class FtrlModel(ctypes.Structure):
    _fields_ = [
        ...
        ('nf', ctypes.POINTER(ctypes.c_float)),
        ('zf', ctypes.POINTER(ctypes.c_float)),
        ('wf', ctypes.POINTER(ctypes.c_float)),
        ('sum_f', ctypes.POINTER(ctypes.c_float)),
        ('num_factors', ctypes.c_int32),
...
_lib.ftrl_init_model.argtypes = [FtrlParams_ptr, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32]
...
class FtrlProximal:
    ...
    def __init__(self, d0=1, d1=1, d2=1, dim=8, alpha=0.1, beta=0.1, l1=0.1, l2=0.1, model_type='classification'):
    ...
    def init_model(self, X):
        ...
        self._model = _lib.ftrl_init_model(self._params, num_features, self.dim, self.d0, self.d1, self.d2)
